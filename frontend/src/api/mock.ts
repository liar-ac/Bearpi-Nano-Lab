...
const sensorTemplates = [
  ...
  { code: 'current', name: '工作电流', unit: 'mA', description: '开发板工作电流，优先使用ADC采样值，未配置采样时使用估算值', min: 0, max: 500 },
  { code: 'power', name: '功耗', unit: 'mW', description: '开发板瞬时功耗，优先由实测电压/电流计算，未配置采样时使用估算值', min: 0, max: 2500 },
